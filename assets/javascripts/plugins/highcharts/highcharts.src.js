...
SVGElement.prototype = {
	...
	*/
	...
	destroy: function () {
		...
		// In case of useHTML, clean up empty container2 emulating SVG groups (#1960, #2393, #2697).
...
Pointer.prototype = {
	...
	oncontainer3ouseDown: function (e) {
	 ...
	 */
	oncontainer3ouseLeave: function () {
	...
	oncontainer3ouseMove: function (e) {
	...
	setDOMEvents: function () {
		...
		container.onmousedown = function (e) {
			pointer.oncontainer3ouseDown(e);
		};
		container.onmousemove = function (e) {
			pointer.oncontainer3ouseMove(e);
		};
		container.onclick = function (e) {
			pointer.onContainerClick(e);
		};
		addEvent(container, 'mouseleave', pointer.oncontainer3ouseLeave);
		if (chartCount === 1) {
	...
	destroy: function () {
		...
		removeEvent(this.chart.container, 'mouseleave', this.oncontainer3ouseLeave);
		if (!chartCount) {
